...
<body>
    <div class="container-1" >
        ...
        <main class="main">
            <form class="lc-vertical-alignment" action="" method="post">
                <input  class="box-large input-boder-none mgt-5" type="text"  placeholder="회원가입한 계정을 입력하세요"/>
            ...
            <form class="lc-vertical-alignment" action="" method="post">
                ...
                <input type="submit" class="box-large  mgt-5 input-boder-none color-bg-green-2 color-white-2 " value="인증번호 확인"/>
            </form>
        </main>
    </div>
</body>
