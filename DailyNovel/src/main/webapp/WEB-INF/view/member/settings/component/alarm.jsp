...
<body>
    <section class="container-1">
        <header class="header lc-center top-sticky">
            <div class="box-large color-bg-green-2 h1 mgt-3">알림</div>
        </header>

        <section class="main lc-center flex-column">
            <div class="l-box-short mgt-5">
                <div class="name">알림</div>
                <div class="content">
                    <form action="">
                        <input type="checkbox" name="web-alarm" class="box-check">
                    </form>
                </div>
            </div>

            <div class="l-box-short mgt-5">
                <div class="name">카톡</div>
                <div class="content">
                    <input type="checkbox" name="katolk-alarm" class="box-check">
                </div>
            </div>
            <div class="l-box-short mgt-5">
                <div class="name">시간</div>
                <div class="content"><input type="time" name="" id="" value="22:00"></div>
            </div>
